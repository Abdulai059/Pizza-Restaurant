...
function Button({ children, disabled, to, variant = "primary", ...props }) {
  const base =
  ...
  return (
    <button disabled={disabled} className={styles[variant]} {...props}>
      {children}
    </button>
  );
}
